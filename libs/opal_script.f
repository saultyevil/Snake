      ...
      ! The numbers to feed the interpolation routines
      real :: T6, R, X, Z
      ...
      ! Get the args and etc
      if (iargc().gt.4 .or. iargc().lt.4) then
            write(*,*) "4 arguments pls"
            write(*,*) "T6 R X Z"
            stop
      end if
...
c***********************************************************************
c
      subroutine kappa (izi,mzin,xh,t6,r)
...
c..... to use kappa insert common/e/ in the calling routine.
